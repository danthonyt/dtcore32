...
HD_PWD='/home/david/Documents/work/dtcore32/vivado/dtcore32.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dtcore32_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dtcore32_top.tcl -notrace
