...
HD_PWD='/home/david/Documents/work/dtcore32/vivado/riscv/riscv.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dtcore32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dtcore32.tcl -notrace
